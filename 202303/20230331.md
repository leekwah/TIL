...
public class PasswordValidatorTest {
    ...
    void validatePasswordTest2() {
        assertThatCode(() -> PasswordValidator.validate("kwah"))
...
- validatePasswordTest2는 8자리가 미만("kwah"라고 4글자)이기 때문에, IllegalArgumentExcpetion 예외가 발생하게 된다.
